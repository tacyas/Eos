...
#
$newstack -size ,60 -offset 0,0 -xf BBa.xf BBa.st BBa.ali
$sampletilt 25 34 226 BBa mida.rec tilta.com
# THESE ARE COMMANDS TO MAKE AN ALIGNED STACK FROM THE ORIGINAL STACK
#
####CreatedVersion#### 3.4.4
#
...
# 300 pixels above the center, etc.
#
$newstack -size ,60 -offset 0,176 -xf BBa.xf BBa.st BBa.ali
$sampletilt 25 34 402 BBa topa.rec tilta.com
# THESE ARE COMMANDS TO MAKE AN ALIGNED STACK FROM THE ORIGINAL STACK
#
####CreatedVersion#### 3.4.4
#
...
#
$newstack -size ,60 -offset 0,-176 -xf BBa.xf BBa.st BBa.ali
$sampletilt 25 34 50 BBa bota.rec tilta.com
