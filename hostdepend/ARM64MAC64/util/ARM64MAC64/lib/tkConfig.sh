...
# installed.
TK_PREFIX='/Users/tacyas/Eos/util/ARM64MAC64'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/tacyas/Eos/util/ARM64MAC64'

# -I switch(es) to use to make all of the X11 include files accessible:
TK_XINCLUDES='-I/opt/X11/include'

# Linker switch(es) to use to link with the X11 library archive.
TK_XLIBSW='-L/opt/X11/lib -lX11 -Wl,-weak-lXss -lXext'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/Users/tacyas/Eos/util/src/TclTk/tk8.6.12/unix -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/tacyas/Eos/util/ARM64MAC64/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/tacyas/Eos/util/ARM64MAC64/include'
...
# compiled.
TK_SRC_DIR='/Users/tacyas/Eos/util/src/TclTk/tk8.6.12'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/Users/tacyas/Eos/util/src/TclTk/tk8.6.12/unix -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/tacyas/Eos/util/ARM64MAC64/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/Users/tacyas/Eos/util/src/TclTk/tk8.6.12/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/Users/tacyas/Eos/util/ARM64MAC64/lib/libtkstub8.6.a'
