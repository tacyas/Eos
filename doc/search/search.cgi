...
$basedir = '/users/html/Eos/';
$baseurl = 'http://tkyemghp.phys.s.u-tokyo.ac.jp/Eos/';
@files = ('*.html');
$title = "Eos Document Search";
$title_url = 'http://tkyemghp.phys.s.u-tokyo.ac.jp/Eos/';
$search_url = 'http://tkyemghp.phys.s.u-tokyo.ac.jp/Eos/search/search.html';
