...
void
lmolvieMouseParallel(int button, int state, int x, int y)
{
...
void
lmolvieMouseMotionParallel(int x, int y)
{
...
void
lmolvieMousePassiveMotionParallel(int x, int y)
{
