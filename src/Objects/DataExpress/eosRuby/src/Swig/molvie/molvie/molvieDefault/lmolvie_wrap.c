...
#define SWIGTYPE_p_GLdouble swig_types[0]
#define SWIGTYPE_p_GLfloat swig_types[1]
#define SWIGTYPE_p_cameraInfo swig_types[2]
#define SWIGTYPE_p_char swig_types[3]
#define SWIGTYPE_p_contourLinesSet swig_types[4]
#define SWIGTYPE_p_operationMode swig_types[5]
...
#define SWIG_init    Init_lmolvie
#define SWIG_name    "Lmolvie"

static VALUE mLmolvie;
...
_wrap_operationModeGet(int argc, VALUE *argv, VALUE self) {
  ...
  result = operationModeGet();
  vresult = SWIG_NewPointerObj((operationMode *)memcpy((operationMode *)malloc(sizeof(operationMode)),&result,sizeof(operationMode)), SWIGTYPE_p_operationMode, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
}
...
_wrap_operationModeSet(int argc, VALUE *argv, VALUE self) {
  ...
  {
    res1 = SWIG_ConvertPtr(argv[0], &argp1, SWIGTYPE_p_operationMode,  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "operationMode","operationModeSet", 1, argv[0] )); 
    }  
    if (!argp1) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "operationMode","operationModeSet", 1, argv[0]));
    } else {
      arg1 = *((operationMode *)(argp1));
    }
  }
...
SWIGINTERN VALUE
_wrap_getMyLightPos(int argc, VALUE *argv, VALUE self) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  GLfloat *result = 0 ;
  ...
  ecode1 = SWIG_AsVal_int(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","getMyLightPos", 1, argv[0] ));
  } 
  arg1 = (int)(val1);
  result = (GLfloat *)getMyLightPos(arg1);
...
static swig_type_info _swigt__p_cameraInfo = {"_p_cameraInfo", "cameraInfo *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_contourLinesSet = {"_p_contourLinesSet", "contourLinesSet *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_operationMode = {"_p_operationMode", "operationMode *", 0, 0, (void*)0, 0};
...
extern "C"
#endif
SWIGEXPORT void Init_lmolvie(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mLmolvie = rb_define_module("Lmolvie");
  ...
  rb_define_module_function(mLmolvie, "lmolvieInitNormal", _wrap_lmolvieInitNormal, -1);
  rb_define_module_function(mLmolvie, "lmolvieIdleNormal", _wrap_lmolvieIdleNormal, -1);
  rb_define_module_function(mLmolvie, "lmolvieDisplayNormal", _wrap_lmolvieDisplayNormal, -1);
  rb_define_module_function(mLmolvie, "lmolvieReshapeNormal", _wrap_lmolvieReshapeNormal, -1);
  rb_define_module_function(mLmolvie, "myCameraRotateY", _wrap_myCameraRotateY, -1);
  rb_define_module_function(mLmolvie, "lmolvieMouse", _wrap_lmolvieMouse, -1);
  rb_define_module_function(mLmolvie, "lmolvieMouseMotion", _wrap_lmolvieMouseMotion, -1);
  rb_define_module_function(mLmolvie, "lmolvieMousePassiveMotion", _wrap_lmolvieMousePassiveMotion, -1);
  rb_define_module_function(mLmolvie, "lmolvieMouseDrive", _wrap_lmolvieMouseDrive, -1);
  rb_define_module_function(mLmolvie, "lmolvieMouseMotionDrive", _wrap_lmolvieMouseMotionDrive, -1);
  rb_define_module_function(mLmolvie, "lmolvieMousePassiveMotionDrive", _wrap_lmolvieMousePassiveMotionDrive, -1);
  rb_define_module_function(mLmolvie, "lmolvieMouseParallel", _wrap_lmolvieMouseParallel, -1);
  rb_define_module_function(mLmolvie, "lmolvieMouseMotionParallel", _wrap_lmolvieMouseMotionParallel, -1);
  rb_define_module_function(mLmolvie, "lmolvieMousePassiveMotionParallel", _wrap_lmolvieMousePassiveMotionParallel, -1);
  rb_define_module_function(mLmolvie, "lmolvieMouseMulti", _wrap_lmolvieMouseMulti, -1);
  rb_define_module_function(mLmolvie, "lmolvieMouseMotionMulti", _wrap_lmolvieMouseMotionMulti, -1);
  rb_define_module_function(mLmolvie, "lmolvieMousePassiveMotionMulti", _wrap_lmolvieMousePassiveMotionMulti, -1);
  rb_define_module_function(mLmolvie, "lmolvieKeyboard", _wrap_lmolvieKeyboard, -1);
  rb_define_module_function(mLmolvie, "lmolvieKeyboardNormal", _wrap_lmolvieKeyboardNormal, -1);
  rb_define_module_function(mLmolvie, "lmolvieKeyboardDrive", _wrap_lmolvieKeyboardDrive, -1);
  rb_define_module_function(mLmolvie, "lmolvieKeyboardParallel", _wrap_lmolvieKeyboardParallel, -1);
  rb_define_module_function(mLmolvie, "lmolvieKeyboardSurface", _wrap_lmolvieKeyboardSurface, -1);
  rb_define_module_function(mLmolvie, "lmolvieInitParallel", _wrap_lmolvieInitParallel, -1);
  rb_define_module_function(mLmolvie, "lmolvieDisplayParallel", _wrap_lmolvieDisplayParallel, -1);
  rb_define_module_function(mLmolvie, "lmolvieReshapeParallel", _wrap_lmolvieReshapeParallel, -1);
  rb_define_module_function(mLmolvie, "operationModeGet", _wrap_operationModeGet, -1);
  rb_define_module_function(mLmolvie, "operationModeSet", _wrap_operationModeSet, -1);
  rb_define_module_function(mLmolvie, "myCameraRotateX", _wrap_myCameraRotateX, -1);
  rb_define_module_function(mLmolvie, "myCameraRotateZ", _wrap_myCameraRotateZ, -1);
  rb_define_module_function(mLmolvie, "myCameraEyeRotateX", _wrap_myCameraEyeRotateX, -1);
  rb_define_module_function(mLmolvie, "myCameraEyeRotateY", _wrap_myCameraEyeRotateY, -1);
  rb_define_module_function(mLmolvie, "myCameraTranslateX", _wrap_myCameraTranslateX, -1);
  rb_define_module_function(mLmolvie, "myCameraTranslateY", _wrap_myCameraTranslateY, -1);
  rb_define_module_function(mLmolvie, "myCameraTranslateZ", _wrap_myCameraTranslateZ, -1);
  rb_define_module_function(mLmolvie, "resetMyCamera", _wrap_resetMyCamera, -1);
  rb_define_module_function(mLmolvie, "getMyCamera", _wrap_getMyCamera, -1);
  rb_define_module_function(mLmolvie, "upCalc", _wrap_upCalc, -1);
  rb_define_module_function(mLmolvie, "moveMyCamera", _wrap_moveMyCamera, -1);
  rb_define_module_function(mLmolvie, "lmolvieLightSet", _wrap_lmolvieLightSet, -1);
  rb_define_module_function(mLmolvie, "getMyLightPos", _wrap_getMyLightPos, -1);
  rb_define_module_function(mLmolvie, "monoSound", _wrap_monoSound, -1);
  rb_define_module_function(mLmolvie, "lmolvieVoice", _wrap_lmolvieVoice, -1);
  rb_define_module_function(mLmolvie, "drawContour", _wrap_drawContour, -1);
  rb_define_module_function(mLmolvie, "lmolvieViewerIdle", _wrap_lmolvieViewerIdle, -1);
  rb_define_module_function(mLmolvie, "lmolvieViewerKeyboard", _wrap_lmolvieViewerKeyboard, -1);
  rb_define_module_function(mLmolvie, "lmolvieViewerSpecial", _wrap_lmolvieViewerSpecial, -1);
  rb_define_module_function(mLmolvie, "lmolvieViewerMouse", _wrap_lmolvieViewerMouse, -1);
  rb_define_module_function(mLmolvie, "lmolvieViewerMouseMotion", _wrap_lmolvieViewerMouseMotion, -1);
  rb_define_module_function(mLmolvie, "lmolvieViewerMousePassiveMotion", _wrap_lmolvieViewerMousePassiveMotion, -1);
  rb_define_module_function(mLmolvie, "lmolvieViewerDisplay", _wrap_lmolvieViewerDisplay, -1);
  rb_define_module_function(mLmolvie, "lmolvieMrcViewerKeyboard", _wrap_lmolvieMrcViewerKeyboard, -1);
  rb_define_module_function(mLmolvie, "lmolvieMrcViewerMouse", _wrap_lmolvieMrcViewerMouse, -1);
  rb_define_module_function(mLmolvie, "lmolvieMrcViewerMouseMotion", _wrap_lmolvieMrcViewerMouseMotion, -1);
  rb_define_module_function(mLmolvie, "lmolvieMrcViewerMousePassiveMotion", _wrap_lmolvieMrcViewerMousePassiveMotion, -1);
  rb_define_module_function(mLmolvie, "lmolvieMrcViewerDisplay", _wrap_lmolvieMrcViewerDisplay, -1);
  rb_define_module_function(mLmolvie, "lmolvieProjectionKeyboard", _wrap_lmolvieProjectionKeyboard, -1);
  rb_define_module_function(mLmolvie, "lmolvieProjectionMouse", _wrap_lmolvieProjectionMouse, -1);
  rb_define_module_function(mLmolvie, "lmolvieProjectionMouseMotion", _wrap_lmolvieProjectionMouseMotion, -1);
  rb_define_module_function(mLmolvie, "lmolvieProjectionMousePassiveMotion", _wrap_lmolvieProjectionMousePassiveMotion, -1);
  rb_define_module_function(mLmolvie, "lmolvieDockKeyboard", _wrap_lmolvieDockKeyboard, -1);
  rb_define_module_function(mLmolvie, "displayMultiPDB1", _wrap_displayMultiPDB1, -1);
  rb_define_module_function(mLmolvie, "lmolvieDockDisplay", _wrap_lmolvieDockDisplay, -1);
  rb_define_module_function(mLmolvie, "lmolvieFlightKeyboard", _wrap_lmolvieFlightKeyboard, -1);
  rb_define_module_function(mLmolvie, "lmolvieFlightDisplay", _wrap_lmolvieFlightDisplay, -1);
  rb_define_module_function(mLmolvie, "lmolvieFlightIdle", _wrap_lmolvieFlightIdle, -1);
}
