...
int bad_code_count;
int out_line() {printf("Not supported: out_line");}
int get_byte() {printf("Not supported: get_byte");}
const char _nl_C_LC_CTYPE_toupper[10];
const char _nl_C_LC_CTYPE_tolower[10];
const char _nl_C_LC_CTYPE_class[10];
