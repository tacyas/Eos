/*
# matrix3DEulerAngles.c  1.1
# The latest update : 07/14/96 at 21:22:03
#
#@(#) matrix3DEulerAngles ver 1.1
#@(#) Created by 
#@(#)
#@(#) Usage : matrix3DEulerAngles 
#@(#) Attention
#@(#)
*/
static char __sccs_id[] = "@(#)matrix3DEulerAngles ver1.1; Date:96/07/14 @(#)";
