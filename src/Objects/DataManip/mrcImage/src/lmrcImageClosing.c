...
#
#%Z% lmrcImageClosing ver %I%
#%Z% Created by 
#%Z%
#%Z% Usage : lmrcImageClosing 
#%Z% Attention
#%Z%
*/
static char __sccs_id[] = "%Z%lmrcImageClosing ver%I%; Date:%D% %Z%";

#include "./lmrcImageMorphology.h"

void 
lmrcImageClosing(mrcImage* dst, mrcImage* src, lmrcImageMorphologyInfo linfo, int times, int mode)
{
	int i;
	mrcImage srctmp; 
	mrcImage dsttmp; 
