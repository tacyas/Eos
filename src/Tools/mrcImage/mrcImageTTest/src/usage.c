...
usage(char* thisProgram)
{
    ...
    fprintf(stderr, "    [-o[utput]           Out                 (NULL      ).as(outFile             ) ] :Optional  :Output: Probability\n");
    fprintf(stderr, "    [-t[Value]           OutT                (NULL      ).as(outFile             ) ] :Optional  :Output: t-value\n");
