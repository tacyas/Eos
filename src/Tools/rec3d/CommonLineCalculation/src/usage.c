...
usage(char* thisProgram)
{
    ...
    fprintf(stderr, "    [-I[nputfilelist]    InList              (NULL      ).as(inFileListNoOpen    ) ] :Optional  :InputDatalistFile\n");
    ...
    fprintf(stderr, "    [-I[nput]m[ode]      Inputmode           (0         ).as(Integer             ) ] :Optional  :InputMode\n");
    additionalUsage();
}
