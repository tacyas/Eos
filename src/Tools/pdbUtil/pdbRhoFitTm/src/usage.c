...
usage(char* thisProgram)
{
    ...
    fprintf(stderr, "    [-Sx                 Sx                  (50        ).as(Real                ) ] :Essential :x of rotation axis\n");
    fprintf(stderr, "    [-Sy                 Sy                  (110       ).as(Real                ) ] :Essential :y of rotation axis\n");
    fprintf(stderr, "    [-Sz                 Sz                  (110       ).as(Real                ) ] :Essential :z of rotation axis\n");
